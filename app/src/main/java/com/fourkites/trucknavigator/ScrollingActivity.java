...
public class ScrollingActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* MapFrag mapFrag = MapFrag.newInstance();
        getFragmentManager().beginTransaction().add(R.id.mapFrag, mapFrag, "Map Frag").commit();*/
    }
...
<uses-permission android:name="android.permission.WAKE_LOCK" />*/
       ...
       /*
        ...
        requiredSDKPermissions.add(Manifest.permission.CHANGE_NETWORK_STATE);
        requiredSDKPermissions.add(Manifest.permission.CHANGE_WIFI_STATE);
        requiredSDKPermissions.add(Manifest.permission.READ_PHONE_STATE);
        requiredSDKPermissions.add(Manifest.permission.WAKE_LOCK);*/
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                         ...
                         */
                        m_mapView = new MapView(ScrollingActivity.this, isTtsEnabled, tts);
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(ScrollingActivity.this, 100);
            ...
            case 100: {
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText(ScrollingActivity.this, "Please turn on the location for navigation", Toast.LENGTH_SHORT).show();
                        break;
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                createCircularReveal.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        mToolbar.setBackgroundColor(getThemeColor(ScrollingActivity.this, R.attr.colorPrimary));
                    }
                });
                createCircularReveal.start();
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.addStop) {
           /* if (m_mapView != null)
                m_mapView.addWaypoint(new Stop());*/
